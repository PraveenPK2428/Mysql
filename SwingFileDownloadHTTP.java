...
public class SwingFileDownloadHTTP extends JFrame implements
    ...
    private JFilePicker filePicker = new JFilePicker("Save in directory: ","Browse...");
    ...
    private void buttonDownloadActionPerformed(ActionEvent event) 
    {
        ...
        if (saveDir.equals("")) 
        {
            JOptionPane.showMessageDialog(this,
                    "Please choose a directory save file!", "Error",JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        {
            JOptionPane.showMessageDialog(this,
                    "Error executing upload task: " + ex.getMessage(), "Error",JOptionPane.ERROR_MESSAGE);
        }      
    }
